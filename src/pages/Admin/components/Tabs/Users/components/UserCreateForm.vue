<template>
  <Form class="form">
    <FormInput
      ...
      :placeholder="$t('admin.userCreateForm.name')"
      variant="contained"
    />
    <FormInput
      v-model="userModel.surname"
      :placeholder="$t('admin.userCreateForm.surname')"
      variant="contained"
    />
    <FormInput
      v-model="userModel.email"
      :placeholder="$t('admin.userCreateForm.email')"
      variant="contained"
    />
    <InputSelect
      ...
      :triggerPlaceholder="$t('admin.articleForm.department')"
    />
    <InputSelect
    ...
    <FormInput
      ...
      :placeholder="$t('admin.userCreateForm.password')"
      variant="contained"
    />
    <BaseButton
      class="form_submit"
...
<script setup lang="ts">
  ...
  const emit = defineEmits<(e: 'createUser', value: IUserCreateDTOReq) => void>();

  const submit = () => {
    emit('createUser', userModel.value);
  };
</script>
